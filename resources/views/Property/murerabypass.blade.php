                ...
                <div class="serv-grids-main-1 row">
                    <div class="col-md-4 serv-grid1">
                        <div class="inner_grid">
                            <h3>Murera Bypass 1</h3>
                            <p></p>
                            <a href="{{url('murerabypass_bookings')}}" data-toggle="" data-target="" role="button">Buying and Bookings</a>
                        </div>
                    </div>
                    <div class="col-md-4 serv-grid2">
                        <div class="inner_grid">
                            <h3>Murera Bypass 2 </h3>
                            <p></p>
                            <a href="{{url('murerabypass_bookings')}}" data-toggle="" data-target="" role="button">Buying and Bookings</a>
                        </div>
                    </div>
