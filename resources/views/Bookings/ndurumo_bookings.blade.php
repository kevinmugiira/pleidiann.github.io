...
<div class="about_page">
    <div class="container">
        <h3 class="agile">Ndurumo Bookings</h3>
        <div id="parentVerticalTab">
            <div class="resp-tabs-container hor_1">
                <div>

                    <div class="col-md-6 easy-left">
                        <img src="{{asset('asset/images/IMG_5458.jpg')}}" alt=" ">
                    </div>
                    <div class="col-md-6 easy-right">
                        <ul>
                            ...
                            <li><a href="#"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>Within your Bugdet </a></li>
                            <li><a href="{{url('ndarashabook')}}" class="btn btn-primary">Book This Plot</a></li>
    ...
    <div class="container">
        ...
        <div class="inner_sec_info_wthree_agile row">
            <div class="col-md-8 map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.9871917261817!2d37.03625191380146!3d-1.1695067358374658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f41604bbe01e5%3A0xd8c8159e8143c18f!2sNdururumo+Primary+School!5e0!3m2!1sen!2ske!4v1526902124143" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>            </div>
            <div class="clearfix"></div>
        </div>
    </div>
