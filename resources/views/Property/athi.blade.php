        ...
        <div class="container">
            ...
            <div class="service-grids row">
                <div class="col-lg-4 service_left_grid">
                    <img width="448" height="299" src="{{asset('asset/images/3267.jpg')}}" alt="" class="img-fluid" />
                </div>
                ...
                <div class="serv-grids-main-1 row">
                    <div class="col-md-4 serv-grid1">
                        <div class="inner_grid">
                            <h3>Athi 1</h3>
                            <p></p>
                            <a href="{{url('athi_bookings')}}" data-toggle="" data-target="page" role="button">Buying and Bookings</a>
                        </div>
                    </div>
