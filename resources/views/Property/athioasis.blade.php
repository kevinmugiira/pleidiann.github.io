                ...
                <div class="serv-grids-main-1 row">
                    <div class="col-md-4 serv-grid1">
                        <div class="inner_grid">
                            <h3>Athi Oasis 1</h3>
                            <p></p>
                            <a href="{{url('athioasis_bookings')}}" data-toggle="" data-target="" role="button">Buying and Bookings</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 serv-grid3">
                        <div class="inner_grid">
                            <h3>Athi Oasis 3</h3>
                            <p></p>
                            <a href="{{url('athioasis_bookings')}}" data-toggle="" data-target="r" role="button">Buying and Bookings</a>
                        </div>
                    </div>
                    <div class="col-md-4 serv-grid3">
                        <div class="inner_grid">
