                ...
                <div class="serv-grids-main-1 row">
                    <div class="col-md-4 serv-grid1">
                        <div class="inner_grid">
                            <h3>Bypass Mugetho 1</h3>
                            <p></p>
                            <a href="{{url('bypassmugetho_bookings')}}" data-toggle="" data-target="" role="button">Buying and Bookings</a>
                        </div>
                    </div>
                    <div class="col-md-4 serv-grid2">
                        <div class="inner_grid">
                            <h3>Bypass Mugetho 2 </h3>
                            <p></p>
                            <a href="{{url('bypassmugetho_bookings')}}" data-toggle="" data-target="" role="button">Buying and Bookings</a>
                        </div>
                    </div>
