...
<html>
<head>
    <title>Jawaki payment Form</title>
    <!-- for-mobile-apps -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //for-mobile-apps -->
    <link href="{{asset('asset/payment/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
    <link href='//fonts.googleapis.com/css?family=Fugaz+One' rel='stylesheet' type='text/css'>
    <link href='//fonts.googleapis.com/css?family=Alegreya+Sans:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,800,800italic,900,900italic' rel='stylesheet' type='text/css'>
    <link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
    <script type="text/javascript" src="{{asset('asset/payment/js/jquery.min.js')}}"></script>
</head>
<body>
<div class="main">
    <h1> Jawaki Payment Form</h1>
    <div class="content">

        <script src="{{asset('asset/payment/js/easyResponsiveTabs.js')}}" type="text/javascript"></script>
    ...
    <p class="footer">Copyright © 2018 Payment Form Jawaki Properties. All Rights Reserved | Template by <a href="https://air-bi.com" target="_blank">Air-bi Technologies</a></p>
</div>
</body>
</html>