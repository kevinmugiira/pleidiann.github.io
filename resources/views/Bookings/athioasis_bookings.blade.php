...
<div class="about_page">
    <div class="container">
        <h3 class="agile">Athioasis Bookings</h3>
        <div id="parentVerticalTab">
            <div class="resp-tabs-container hor_1">
                <div>

                    <div class="col-md-6 easy-left">
                        <img src="{{asset('asset/images/IMG_5386.jpg')}}" alt=" ">
                    </div>
                    <div class="col-md-6 easy-right">
                        <ul>
                            ...
                            <li><a href="#"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>Within your Bugdet </a></li>
                            <li><a href="{{url('athioasisbook')}}" class="btn btn-primary">Book This Plot</a></li>
                    ...
                    <p>he plots are 500 metres from the proposed Great Eastern Bypass linking the three major roads i.e Mombasa road-Kang’undo road-Garissa road.</p>
...
<div class="team-page">
    ...
    <!-- <div class="col-md-4 about-poleft">
            <div class="about_img"><img src="{{asset('asset/apart/images/team1.jpg')}}" alt="">
                <h5>Victoria</h5>
                <div class="about_opa">
                    <p>Engineer</p>
        ...
        <div class="col-md-4 about-poleft">
            <div class="about_img"><img src="{{asset('asset/apart/images/team2.jpg')}}" alt="">
                <h5>Thompson</h5>
                <div class="about_opa">
                    <p>Technician</p>
                    <div class="agile-social">
        ...
        <!--<div class="col-md-4 about-poleft">
            <div class="about_img"><img src="{{asset('asset/apart/images/team3.jpg')}}" alt="">
                <h5>Patrick</h5>
                <div class="about_opa">
                    <p>Builder</p>
                    <div class="agile-social">
